...
async function startApp() {
    try {
        ...
        // Perform database operations after connection
        // const user = await Users.findOne({ name: 'John Doe' });
        // console.log('Found user:', user);
    } catch (err) {
        console.error('Error connecting to MongoDB or running queries:', err);
    }
}
...
app.put("/edit-story/:id",authenticateToken,async(req,res)=>{
    ...
    try{
        ...
        const placeholderImgUrl = `http://localhost:8001/assets/placeholder.png`;
